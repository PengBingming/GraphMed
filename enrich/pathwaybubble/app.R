...
source("module/bubble.R",encoding = "utf-8")
...
ui <- bs4DashPage(
  ...
  preloader = list(html = tagList(spin_1(), "Loading ..."), color = "gray"),
  title = "GraphMed",
  fullscreen = T,
  ...
  sidebar = bs4DashSidebar(
    ...
    sidebarMenu(id="sidebar",
                ...
                menuItem("pathway bubble", tabName = "bubble", icon = ionicon(name="bed"),selected = T )
    )
  ),
