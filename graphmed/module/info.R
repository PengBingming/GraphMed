...
helpUI <- function(id) {
  ...
  tagList(
    fluidRow(
      box(title="Workflow", width=6, height=800, background = "white", 
          status='primary', solidHeader=TRUE,
          tags$img(src = "workflow.png", width = "500",height="400",style= "display:block;margin:auto;")
      ),
      box(width=6,title="使用说明",solidHeader=TRUE,status='primary',
          background = "white",height=800,
          tags$h2("使用说明"),
          tags$hr(),
          tags$a("旧版本地址：https://shiny.chcmu.com.cn/oldgraphmed/",href="https://shiny.chcmu.com.cn/oldgraphmed/"),
          tags$hr(),
